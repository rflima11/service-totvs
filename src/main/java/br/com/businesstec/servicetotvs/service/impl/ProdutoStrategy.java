...
public class ProdutoStrategy implements EntidadeStrategy {
    ...
    public void executar(RealizarConsultaSQLResponseDTO realizarConsultaSQLResponseDTO, ControleExecucaoFluxo controleExecucaoFluxo) {
        ...
        produtos.stream().forEach(p -> {
            ...
            produtoCategoriaService.buscarCategoriasPorProdutos(controleExecucaoFluxo, produtoSalvo);
            produtoEcommerceService.salvar(produtoEcommerce, produtoSalvo.getId());
